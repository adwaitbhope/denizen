...
public class AmenitiesOneTimePaymentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ProgressBar) findViewById(R.id.amenities_one_time_payments_progress_bar)).setVisibility(View.VISIBLE);
        ...
        recyclerView = findViewById(R.id.amenities_one_time_payments_recycler_view);
    ...
    private class GetBookingsAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            temporaryDataset.addAll(bookingDao.getWithPaymentsOnly());
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (adapter != null) {
                ((ProgressBar) findViewById(R.id.amenities_one_time_payments_progress_bar)).setVisibility(View.GONE);
