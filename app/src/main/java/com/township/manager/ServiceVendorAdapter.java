...
public class ServiceVendorAdapter extends RecyclerView.Adapter implements PopupMenu.OnMenuItemClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.threeDots.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.setOnMenuItemClickListener(ServiceVendorAdapter.this);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        serviceVendors = dataset.get(position);
        viewHolder.name.setText(serviceVendors.getFirst_name());
    ...
    private void deleteServiceVendor() {
                ...
                try {
                    ...
                    if (loginJson.getString("login_status").equals("1")) {
                        if (loginJson.getString("request_status").equals("1")) {
                            Log.d("delete","delete");
                            new DeleteServiceVendor().execute();
                        }
                    }
                }
    ...
    private class DeleteServiceVendor extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            serviceVendorDao.delete(serviceVendors.getVendor_id());
            return null;
        }
...
//            finish();
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name, description,threeDots;
        ImageView dispayPic;
        MaterialButton call;
